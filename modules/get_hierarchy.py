...
in_hier = ImageNetHierarchy("/run/media/riccardo/ea24b431-b1e5-4ec3-95b0-fcbaf83641fb/ImageNet/", '/run/media/riccardo/ea24b431-b1e5-4ec3-95b0-fcbaf83641fb/ImageNet/info')



wn_names = ['animal', 'device', 'conveyance', 'implement', 'container', 'equipment', 'clothing', 'appliance', 'covering', 'food', 'structure']
wn_ids = ['n00015388', 'n03183080', 'n03100490', 'n03563967', 'n03094503', 'n03294048', 'n03051540', 'n02729837', 'n03122748', 'n00021265', 'n04341686', 'n04447443','n00019128']#'n00007846','n09287968','n03405265','n07707451']
...
classes = os.listdir('/run/media/riccardo/ea24b431-b1e5-4ec3-95b0-fcbaf83641fb/ImageNet/train')
...
for anchestor, descendant in descendants.items():
    ...
    superclass_wnid, class_ranges, label_map = in_hier.get_superclasses(n_superclasses=n_superclasses, ancestor_wnid=anchestor,balanced=False)
    for lv2_wnid in superclass_wnid:
            ...
            for class_name in classes:
                if in_hier.is_ancestor(lv2_wnid, class_name):
                    fine_syn = wn.synset_from_pos_and_offset('n', int(class_name[1:])).name()
